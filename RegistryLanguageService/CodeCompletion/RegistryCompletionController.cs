                ...
                if (pguidCmdGroup == VSConstants.VSStd2K)
                {
                    switch ((VSConstants.VSStd2KCmdID)nCmdID)
                    {
                        ...
                        case VSConstants.VSStd2KCmdID.TYPECHAR:
                            ...
                            if (@char == RegistrySyntaxFacts.KeySeparator ||
                                @char == RegistrySyntaxFacts.PropertyNameValueDelimiter ||
                                @char == RegistrySyntaxFacts.TypeValueDelimiter)
                                Complete();
                            break;
                        ...
                        switch ((VSConstants.VSStd2KCmdID)nCmdID)
                        {
                            case VSConstants.VSStd2KCmdID.TYPECHAR:
                                ...
                                if (Char.IsLetter(@char) ||
                                    @char == RegistrySyntaxFacts.SectionNameOpeningBracket ||
                                    @char == RegistrySyntaxFacts.KeySeparator ||
                                    @char == RegistrySyntaxFacts.Quote
                                )
                                {
