using RegistryLanguageService.CodeFixes;
...
namespace RegistryLanguageService
{
    ...
    [Name("Registry Suggested Actions")]
    [ContentType(RegistryContentTypeNames.Registry)]
    internal sealed class RegistrySuggestedActionsProvider : ISuggestedActionsSourceProvider
    {
...
#pragma warning restore 649
        ...
        public ISuggestedActionsSource CreateSuggestedActionsSource(ITextView textView, ITextBuffer textBuffer)
        {
            return textBuffer.Properties.GetOrCreateSingletonProperty(
                creator: () => new RegistrySuggestedActions(
                    textView, textBuffer,
        ...
        private sealed class RegistrySuggestedActions : ISuggestedActionsSource
        {
            public RegistrySuggestedActions(
